...
public class CameraMovement : MonoBehaviour
{
    ...
    [Space]
    public float minPanSpeed = 10f;
    public float maxPanSpeed = 20f;
    public float secToMaxSpeed = 1f; //seconds taken to reach max speed;
    ...
    private float panIncrease = 1.0f;
    ...
    void Update()
    {
        ...
        if (rotationEnabled)
        {
            ...
            if (Input.GetMouseButton(0))
            {
                ...
                var rotation = Vector3.up * Time.deltaTime * rotateSpeed * mouseDelta.x*20f;
                rotation += Vector3.left * Time.deltaTime * rotateSpeed * mouseDelta.y*20f;
